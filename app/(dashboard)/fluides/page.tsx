...
const fluidSystems: FluidSystem[] = [
  {
    ...
    color: "#3B82F6",
    bgColor: "bg-blue-50",
    source: "Centrale de bouteilles (18 572 400 FDJ)",
    sourceRoom: "Local Fluides RDC",
    ...
    progress: 25,
    connections: [
      { id: "o2-src", room: "Local Fluides RDC", zone: "Locaux Techniques", type: "source", status: "installed" },
      { id: "o2-1", room: "Box URG 1", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "o2-2", room: "Box URG 2", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "o2-3", room: "Box URG 3", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "o2-4", room: "Box URG 4", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "o2-5", room: "Déchocage", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "o2-6", room: "Petit Chir", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "o2-7", room: "Infirmerie URG", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "o2-8", room: "Bloc Césarienne", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "o2-9", room: "Salle Réveil", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "o2-10", room: "Salle Travail", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "o2-11", room: "Chambre Mat 9", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "o2-12", room: "Chambre Mat 10", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "o2-13", room: "Chambre Mat 11", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "o2-14", room: "Chambre Mat 12", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "o2-15", room: "Chambre Mat 13", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "o2-16", room: "Chambre Mat 14", zone: "Maternité", type: "prise_murale", status: "pending" },
    ],
  },
  {
    id: "vide",
    ...
    source: "Centrale aspiration 2×pompes vide médical",
    sourceRoom: "Local Fluides RDC",
    networkInstalled: true,
    brasageDone: false,
    pressureTestDone: false,
    ...
    progress: 20,
    connections: [
      { id: "v-src", room: "Local Fluides RDC", zone: "Locaux Techniques", type: "source", status: "installed" },
      { id: "v-1", room: "Box URG 1", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "v-2", room: "Box URG 2", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "v-3", room: "Box URG 3", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "v-4", room: "Box URG 4", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "v-5", room: "Déchocage", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "v-6", room: "Petit Chir", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "v-7", room: "Infirmerie URG", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "v-8", room: "Bloc Césarienne", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "v-9", room: "Salle Réveil", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "v-10", room: "Salle Travail", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "v-11", room: "Chambre Mat 9", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "v-12", room: "Chambre Mat 10", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "v-13", room: "Chambre Mat 11", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "v-14", room: "Chambre Mat 12", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "v-15", room: "Chambre Mat 13", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "v-16", room: "Chambre Mat 14", zone: "Maternité", type: "prise_murale", status: "pending" },
    ],
  },
  {
    id: "air",
    ...
    progress: 10,
    connections: [
      { id: "a-src", room: "Local Fluides RDC", zone: "Locaux Techniques", type: "source", status: "installed" },
      { id: "a-1", room: "Box URG 1", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "a-2", room: "Box URG 2", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "a-3", room: "Box URG 3", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "a-4", room: "Box URG 4", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "a-5", room: "Déchocage", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "a-6", room: "Petit Chir", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "a-7", room: "Infirmerie URG", zone: "Urgences", type: "prise_murale", status: "pending" },
      { id: "a-8", room: "Bloc Césarienne", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "a-9", room: "Salle Réveil", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "a-10", room: "Salle Travail", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "a-11", room: "Chambre Mat 9", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "a-12", room: "Chambre Mat 10", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "a-13", room: "Chambre Mat 11", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "a-14", room: "Chambre Mat 12", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "a-15", room: "Chambre Mat 13", zone: "Maternité", type: "prise_murale", status: "pending" },
      { id: "a-16", room: "Chambre Mat 14", zone: "Maternité", type: "prise_murale", status: "pending" },
    ],
  },
]
