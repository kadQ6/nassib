...
const mockReserves: Reserve[] = [
  {
    ...
    gravite: "critique", type: "Structure", responsable: "DJI FU SARL", echeance: "15/01/2026",
  ...
  },
  {
    ...
    gravite: "critique", type: "Sécurité électrique", responsable: "DJI FU SARL", echeance: "10/01/2026",
    statut: "En Cours", joursOuverts: 39, actionRequise: "Pose chemins de câbles avec couvercle et mise à la terre",
  },
  {
    id: "3", numero: "RES-003", date: "08/12/2025", local: "Salle Réveil", lot: "FLU",
    description: "Robinetterie O2 non repérée salle de réveil — prises non identifiées",
    gravite: "critique", type: "Fluides Médicaux", responsable: "DJI FU SARL", echeance: "20/01/2026",
    statut: "Ouverte", joursOuverts: 36, actionRequise: "Pose plaques d'identification normalisées NF S 90-116",
  },
  {
    id: "4", numero: "RES-004", date: "10/12/2025", local: "Local technique RDC", lot: "PLB",
    description: "Fuite détectée réseau EF sous-sol — débit estimé 0,5 L/min",
    gravite: "majeure", type: "Plomberie", responsable: "DJI FU SARL", echeance: "25/01/2026",
  ...
  },
  {
    ...
    gravite: "mineure", type: "Éclairage", responsable: "DJI FU SARL", echeance: "15/02/2026",
    statut: "Ouverte", joursOuverts: 32, actionRequise: "Fourniture et pose luminaire LED selon plan d'exécution",
  },
  {
    id: "6", numero: "RES-006", date: "15/12/2025", local: "Bloc Césarienne", lot: "CVC",
    description: "Grille de soufflage décentrée dans plafond salle bloc césarienne",
    gravite: "majeure", type: "Aéraulique", responsable: "DJI FU SARL", echeance: "30/01/2026",
  ...
  },
  {
    ...
    gravite: "mineure", type: "Revêtements", responsable: "DJI FU SARL", echeance: "28/02/2026",
    statut: "Ouverte", joursOuverts: 26, actionRequise: "Dépose et repose carrelage conforme référence CCTP art. 4.2",
  },
  {
    id: "8", numero: "RES-008", date: "20/12/2025", local: "Salle Travail", lot: "PLB",
    description: "Siphon de sol non posé salle de travail",
    gravite: "majeure", type: "Plomberie", responsable: "DJI FU SARL", echeance: "20/01/2026",
  ...
  },
  {
    ...
    gravite: "critique", type: "Sécurité électrique", responsable: "DJI FU SARL", echeance: "12/01/2026",
    statut: "En Cours", joursOuverts: 22, actionRequise: "Étiquetage complet et mise à jour schéma unifilaire",
  },
  {
    id: "10", numero: "RES-010", date: "24/12/2025", local: "Chambre Maternité 12", lot: "CVC",
    description: "Thermostat ambiance absent chambre maternité 12",
    gravite: "majeure", type: "Régulation", responsable: "DJI FU SARL", echeance: "05/02/2026",
  ...
  },
  {
    ...
    gravite: "majeure", type: "Étanchéité", responsable: "DJI FU SARL", echeance: "10/02/2026",
  ...
  },
  {
    ...
    gravite: "critique", type: "Sécurité incendie", responsable: "DJI FU SARL", echeance: "08/01/2026",
    statut: "Levée", joursOuverts: 0, actionRequise: "Pose BAES conforme NF C 71-800",
  },
  {
    id: "13", numero: "RES-013", date: "02/01/2026", local: "GYN 1", lot: "CFO",
    description: "Prise RJ45 non posée salle GYN 1",
    gravite: "mineure", type: "Courants faibles", responsable: "DJI FU SARL", echeance: "28/02/2026",
  ...
  },
  {
    ...
    gravite: "majeure", type: "Ventilation", responsable: "DJI FU SARL", echeance: "25/01/2026",
  ...
  },
  {
    ...
    gravite: "majeure", type: "Plomberie", responsable: "DJI FU SARL", echeance: "20/02/2026",
    statut: "Ouverte", joursOuverts: 8, actionRequise: "Reprise collecteur EU avec pente réglementaire",
  },
  {
    id: "16", numero: "RES-016", date: "06/01/2026", local: "Laboratoire RDC", lot: "FLU",
    description: "Réseau air comprimé médical non testé laboratoire",
    gravite: "majeure", type: "Fluides Médicaux", responsable: "DJI FU SARL", echeance: "31/01/2026",
    statut: "À Vérifier", joursOuverts: 7, actionRequise: "Test pression 6 bars 24h et procès-verbal",
  },
  {
    id: "17", numero: "RES-017", date: "07/01/2026", local: "Couloir Hospit de Jour", lot: "REV",
    description: "Peinture murs couloir Hospit de Jour non achevée — 40 ml manquants",
    gravite: "mineure", type: "Finitions", responsable: "DJI FU SARL", echeance: "15/02/2026",
    statut: "Ouverte", joursOuverts: 6, actionRequise: "Achèvement peinture lessivable classe 3 couleur RAL 9010",
  },
  {
    id: "18", numero: "RES-018", date: "08/01/2026", local: "Bloc Césarienne", lot: "CFO",
    description: "Luminaire salle Bloc Césarienne non conforme — IRC < 90 requis",
    gravite: "majeure", type: "Éclairage", responsable: "DJI FU SARL", echeance: "10/02/2026",
  ...
  },
  {
    ...
    gravite: "majeure", type: "Étanchéité", responsable: "DJI FU SARL", echeance: "05/02/2026",
    statut: "Levée", joursOuverts: 0, actionRequise: "Reprise relevé étanchéité selon DTU 20.12",
  },
  {
    id: "20", numero: "RES-020", date: "12/01/2026", local: "Déchocage", lot: "FLU",
    description: "Centrale vide médical déchocage — pression résidu 55 kPa vs 40 kPa maxi",
    gravite: "critique", type: "Fluides Médicaux", responsable: "DJI FU SARL", echeance: "18/01/2026",
...
function ReserveDetailModal({ reserve, onClose }: { reserve: Reserve | null; onClose: () => void }) {
  const mockComments = [
    ...
    { author: "DJI FU SARL", date: "14/12/2025", text: "Matériaux commandés, intervention prévue le 20/12." },
  ]
