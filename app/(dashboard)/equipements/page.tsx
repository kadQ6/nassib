...
const EQUIP = [
  ...
  {id:'e4',code:'EQ-DEC-RESPI',nom:"Respirateur réanimation — Déchocage",categorie:'Urgences',local:'Déchocage',local_code:'URG-DEC',marque:'Dräger',modele:'Evita V500',quantite:2,prix_unitaire:9000000,statut:'Non commandé',date_livraison_prevue:'2026-08-01',prerequis:'O₂ et vide installés'},
  {id:'e5',code:'EQ-BIB-INC',nom:'Incubateur néonatologie — Bibonnerie',categorie:'Néonatologie',local:'Chambre Maternité 5',local_code:'MAT-BIB',marque:'GE Healthcare',modele:'Giraffe',quantite:4,prix_unitaire:4200000,statut:'Non commandé',date_livraison_prevue:'2026-10-01',prerequis:'Prises UPS et O₂, CVC terminé'},
  {id:'e6',code:'EQ-URG-MON',nom:'Moniteur multiparamétrique — Box URG',categorie:'Monitoring',local:'Box URG 1',local_code:'URG-BOX1',marque:'Mindray',modele:'iMEC-10',quantite:8,prix_unitaire:3500000,statut:'Non commandé',date_livraison_prevue:'2026-08-01',prerequis:'Prises UPS et O₂ installées'},
  {id:'e7',code:'EQ-DEC-ECHO',nom:'Échographe — Déchocage',categorie:'Urgences',local:'Déchocage',local_code:'URG-DEC',marque:'Philips',modele:'CX50',quantite:1,prix_unitaire:6500000,statut:'Non commandé',date_livraison_prevue:'2026-08-01',prerequis:'Prise UPS, réseau IP'},
  {id:'e8',code:'EQ-REV-MON',nom:'Moniteur réveil — Salle Réveil Mat.',categorie:'Monitoring',local:'Salle Réveil',local_code:'MAT-REV',marque:'Mindray',modele:'BeneVision N17',quantite:2,prix_unitaire:4800000,statut:'Non commandé',date_livraison_prevue:'2026-09-01',prerequis:'O₂ et vide installés, prise UPS'},
  {id:'e9',code:'EQ-TRAV-TOCO',nom:'Cardiotocographe — Salle de Travail',categorie:'Obstétrique',local:'Salle Travail',local_code:'MAT-TRAV',marque:'GE Healthcare',modele:'Corometrics',quantite:1,prix_unitaire:2100000,statut:'Non commandé',date_livraison_prevue:'2026-09-01',prerequis:'Prises électriques installées'},
  ...
  {id:'e14',code:'EQ-URG-POMP',nom:'Pousse-seringue électrique — Déchocage',categorie:'Urgences',local:'Déchocage',local_code:'URG-DEC',marque:'Fresenius Kabi',modele:'Agilia',quantite:4,prix_unitaire:280000,statut:'Commandé',date_livraison_prevue:'2026-07-01',prerequis:'Prises UPS'},
