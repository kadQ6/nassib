...
const PHASES = [
  {
    ...
    taches: [
      { nom: 'Fondations et radier',       debut: '2024-03-01', fin: '2024-05-31', avancement: 100, responsable: 'BNTPH',     priorite: 'Critique' },
      { nom: 'Structure béton armé',        debut: '2024-04-01', fin: '2024-09-30', avancement:  80, responsable: 'BNTPH',     priorite: 'Haute'    },
      { nom: 'Maçonnerie briques',          debut: '2024-07-01', fin: '2024-11-30', avancement:  60, responsable: 'BNTPH',     priorite: 'Normale'  },
      { nom: 'Enduits et crépis',           debut: '2024-09-01', fin: '2024-11-30', avancement:  30, responsable: 'BNTPH',     priorite: 'Normale'  },
    ],
  },
  {
    ...
    taches: [
      { nom: 'Cloisons et doublages',       debut: '2024-08-01', fin: '2025-02-28', avancement:  50, responsable: 'BNTPH',     priorite: 'Haute'   },
      { nom: 'Menuiseries intérieures',     debut: '2024-11-01', fin: '2025-04-30', avancement:  20, responsable: 'BNTPH',     priorite: 'Normale' },
      { nom: 'Revêtements sols',            debut: '2025-01-01', fin: '2025-05-31', avancement:  10, responsable: 'BNTPH',     priorite: 'Normale' },
      { nom: 'Peintures et finitions',      debut: '2025-03-01', fin: '2025-06-30', avancement:   0, responsable: 'BNTPH',     priorite: 'Basse'   },
    ],
  },
  {
    ...
    taches: [
      { nom: 'Courant fort CFO',            debut: '2024-09-01', fin: '2025-06-30', avancement:  40, responsable: 'ElecMed',      priorite: 'Haute'    },
      { nom: 'Gaz médicaux',               debut: '2024-10-01', fin: '2025-08-31', avancement:  20, responsable: 'FluidMed',     priorite: 'Critique' },
      { nom: 'CVC et ventilation',          debut: '2024-10-01', fin: '2025-08-31', avancement:  25, responsable: 'CVC Pro',      priorite: 'Haute'    },
      { nom: 'Réseau VDI',                 debut: '2024-11-01', fin: '2025-07-31', avancement:  20, responsable: 'Réseau Data',  priorite: 'Normale'  },
    ],
  },
  {
    ...
    taches: [
      { nom: 'Équipements biomédicaux',     debut: '2025-07-01', fin: '2025-11-30', avancement:   0, responsable: 'BioEquip',    priorite: 'Critique' },
      { nom: 'Mobilier médical',            debut: '2025-06-01', fin: '2025-10-31', avancement:   0, responsable: 'MediMob',     priorite: 'Haute'    },
  ...
  },
  {
    ...
    taches: [
      { nom: 'Essais techniques MEP',       debut: '2025-10-01', fin: '2025-11-30', avancement:   0, responsable: 'Toutes entreprises', priorite: 'Critique' },
      { nom: 'OPR et réserves',            debut: '2025-11-01', fin: '2025-12-15', avancement:   0, responsable: 'M. Kader Omar',       priorite: 'Critique' },
      { nom: 'Levée des réserves',          debut: '2025-12-01', fin: '2025-12-20', avancement:   0, responsable: 'Toutes entreprises', priorite: 'Haute'    },
