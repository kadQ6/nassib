...
const EQUIP = [
  {id:'e1',code:'EQ-BLC-TABLE',nom:"Table de chirurgie — Bloc Césarienne",categorie:'Bloc Opératoire',local:'Bloc Césarienne',local_code:'MAT-BLC',marque:'Maquet',modele:'Alphamaxx',quantite:1,prix_unitaire:8500000,statut:'Non commandé',date_livraison_prevue:'2026-09-01',prerequis:'Sol renforcé, prise 400V, O₂ installé'},
  {id:'e2',code:'EQ-BLC-SCIAL',nom:'Éclairage scialytique — Bloc Césarienne',categorie:'Bloc Opératoire',local:'Bloc Césarienne',local_code:'MAT-BLC',marque:'Trumpf Medical',modele:'iLED 5',quantite:1,prix_unitaire:6200000,statut:'Non commandé',date_livraison_prevue:'2026-09-01',prerequis:'Plafond terminé, accroche fixée'},
  {id:'e3',code:'EQ-BLC-ANES',nom:"Respirateur anesthésie — Bloc Césarienne",categorie:'Anesthésie',local:'Bloc Césarienne',local_code:'MAT-BLC',marque:'Dräger',modele:'Primus',quantite:1,prix_unitaire:12000000,statut:'Non commandé',date_livraison_prevue:'2026-09-01',prerequis:'O₂, vide, air médical installés'},
  {id:'e4',code:'EQ-DEC-RESPI',nom:"Respirateur réanimation — Déchocage",categorie:'Urgences',local:'Salle de Déchocage',local_code:'URG-DEC',marque:'Dräger',modele:'Evita V500',quantite:2,prix_unitaire:9000000,statut:'Non commandé',date_livraison_prevue:'2026-08-01',prerequis:'O₂ et vide installés'},
  {id:'e5',code:'EQ-BIB-INC',nom:'Incubateur néonatologie — Bibonnerie',categorie:'Néonatologie',local:'Bibonnerie & Soins Bébé',local_code:'MAT-BIB',marque:'GE Healthcare',modele:'Giraffe',quantite:4,prix_unitaire:4200000,statut:'Non commandé',date_livraison_prevue:'2026-10-01',prerequis:'Prises UPS et O₂, CVC terminé'},
  {id:'e6',code:'EQ-URG-MON',nom:'Moniteur multiparamétrique — Box URG',categorie:'Monitoring',local:'Box Urgences 1-4',local_code:'URG-BOX1',marque:'Mindray',modele:'iMEC-10',quantite:8,prix_unitaire:3500000,statut:'Non commandé',date_livraison_prevue:'2026-08-01',prerequis:'Prises UPS et O₂ installées'},
  {id:'e7',code:'EQ-DEC-ECHO',nom:'Échographe — Déchocage',categorie:'Urgences',local:'Salle de Déchocage',local_code:'URG-DEC',marque:'Philips',modele:'CX50',quantite:1,prix_unitaire:6500000,statut:'Non commandé',date_livraison_prevue:'2026-08-01',prerequis:'Prise UPS, réseau IP'},
  {id:'e8',code:'EQ-REV-MON',nom:'Moniteur réveil — Salle Réveil Mat.',categorie:'Monitoring',local:'Salle Réveil Bloc Mat.',local_code:'MAT-REV',marque:'Mindray',modele:'BeneVision N17',quantite:2,prix_unitaire:4800000,statut:'Non commandé',date_livraison_prevue:'2026-09-01',prerequis:'O₂ et vide installés, prise UPS'},
  {id:'e9',code:'EQ-TRAV-TOCO',nom:'Cardiotocographe — Salle de Travail',categorie:'Obstétrique',local:'Salle de Travail',local_code:'MAT-TRAV',marque:'GE Healthcare',modele:'Corometrics',quantite:1,prix_unitaire:2100000,statut:'Non commandé',date_livraison_prevue:'2026-09-01',prerequis:'Prises électriques installées'},
  {id:'e10',code:'EQ-MAT-LIT',nom:'Lit hospitalier — Chambres Maternité',categorie:'Hospitalisation',local:'Chambres Maternité 1-14',local_code:'MAT-CH01',marque:'Hillenbrand',modele:'Progressa',quantite:14,prix_unitaire:850000,statut:'Non commandé',date_livraison_prevue:'2026-10-01',prerequis:'Prise 220V'},
  {id:'e11',code:'EQ-RAD-TABLE',nom:'Appareil radiologie numérique',categorie:'Imagerie',local:'Salle de Radiologie',local_code:'RAD-SALLE',marque:'Siemens',modele:'Ysio Max',quantite:1,prix_unitaire:22000000,statut:'Non commandé',date_livraison_prevue:'2026-08-01',prerequis:'Protection plomb, prise 400V, Potter installé'},
  {id:'e12',code:'EQ-GYN-ECHO',nom:"Échographe — Bureaux Gynécologie",categorie:'Imagerie',local:'Bureau GYN 1 & 2',local_code:'CS-GYN1',marque:'Samsung',modele:'HERA W10',quantite:2,prix_unitaire:6500000,statut:'Non commandé',date_livraison_prevue:'2026-07-01',prerequis:'Prise UPS, réseau IP'},
  {id:'e13',code:'EQ-LABO-AUTO',nom:'Analyseur biologique — Mini-Labo URG',categorie:'Laboratoire',local:'Mini-Labo Urgences',local_code:'URG-LABO',marque:'Roche',modele:'cobas c 311',quantite:1,prix_unitaire:8500000,statut:'Non commandé',date_livraison_prevue:'2026-08-01',prerequis:'Prise 220V, eau déminéralisée, ventilation'},
  {id:'e14',code:'EQ-URG-POMP',nom:'Pousse-seringue électrique — Déchocage',categorie:'Urgences',local:'Salle de Déchocage',local_code:'URG-DEC',marque:'Fresenius Kabi',modele:'Agilia',quantite:4,prix_unitaire:280000,statut:'Commandé',date_livraison_prevue:'2026-07-01',prerequis:'Prises UPS'},
  {id:'e15',code:'EQ-MED-LIT',nom:'Lit hospitalier — Chambres Médecine',categorie:'Hospitalisation',local:'Chambre Med 1-7',local_code:'MED-CH01',marque:'Hillenbrand',modele:'Progressa',quantite:7,prix_unitaire:850000,statut:'Non commandé',date_livraison_prevue:'2026-10-01',prerequis:'Prise 220V'},
]
